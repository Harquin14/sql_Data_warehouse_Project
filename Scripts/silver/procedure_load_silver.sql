...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO silver.crm_sales_details(
            sls_ord_num, sls_prd_key, sls_cust_id, sls_order_dt, sls_ship_dt, sls_due_date, sls_sales, sls_quantity, sls_price
        )
        SELECT sls_ord_num, sls_prd_key, sls_cust_id,
            ...
            CASE WHEN sls_order_dt = 0 OR LEN(sls_due_date) <> 8 THEN NULL
                 ELSE CAST(CAST(sls_due_date AS VARCHAR) AS DATE) END AS sls_due_date,
